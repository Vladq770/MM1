...
class Row:
    def __init__(self, name, fr):
        ...
        self.entry_ax = Entry(self.label_frame, validate="key", validatecommand=(fr.register(validate_entry), "%S"), width=13)
        self.entry_ay = Entry(self.label_frame, validate="key", validatecommand=(fr.register(validate_entry), "%S"), width=13)
        ...
        self.entry_ax.insert(END, '0')
        self.entry_ay.insert(END, '0')
        ...
        self.entry_ax.pack(side=LEFT, ipadx=5, padx=5)
        self.entry_ay.pack(side=LEFT, ipadx=5, padx=5)
